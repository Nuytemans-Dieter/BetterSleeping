...
//            messenger.sendMessage(player, "&cYou have to wait <time> more seconds before shouting in this world", new MsgEntry("<time>", "" + seconds));
//            return true;
//        }
//
//        cooldownMap.put( world, System.currentTimeMillis() );
//        messenger.sendMessage(world.getPlayers(), "Please go to bed, some players want to sleep.");
//        return true;
//    }
//
